...
//Called when a user taps on anotification in the foreground
...
//  // "opendInForeground" is data send to modules in userInfo
//  [userData setObject:@1 forKey:@"opendInForeground"];
